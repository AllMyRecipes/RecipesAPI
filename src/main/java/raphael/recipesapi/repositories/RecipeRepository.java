...
public interface RecipeRepository extends JpaRepository<Recipe,Long> {
    ...
    @Query("SELECT DISTINCT q.recipe FROM Quantity q WHERE q.ingredient.id = :ingredientId")
    Page<Recipe> findRecipesByIngredientId(Pageable page,@Param("ingredientId") Long ingredientId);
}
